...
export default function SignInPage() {
  const { googleSignIn, user, isMounted } = useAuth()
  ...
  return (
    <Card className="flex flex-col items-center justify-center h-[300px]">
      <CardHeader className="text-center">
        ...
        <CardDescription className="text-wrap max-w-[350px]">
          Sign in to capture, share, and cherish your memories with loved ones
        </CardDescription>
      </CardHeader>
